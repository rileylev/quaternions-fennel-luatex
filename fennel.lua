...
package.preload["fennel.repl"] = package.preload["fennel.repl"] or function(...)
  ...
  local function default_on_error(errtype, err)
    local function _659_()
      local _658_0 = errtype
      if (_658_0 == "Runtime") then
  ...
  local function splice_save_locals(env, lua_source, scope)
    ...
    local function _668_()
      local _666_0, _667_0 = lua_source:match("^(.*)[\n ](return .*)$")
      if ((nil ~= _666_0) and (nil ~= _667_0)) then
        local body = _666_0
        local _return = _667_0
  ...
  local function completer(env, scope, text, _3ffulltext, _from, _to)
    ...
    local function add_partials(input, tbl, prefix)
      ...
      for k, is_mangled in utils.allpairs(_670_()) do
    ...
    do
      local _679_0 = tostring((_3ffulltext or text)):match("^%s*,([^%s()[%]]*)$")
      if (nil ~= _679_0) then
        local cmd_fragment = _679_0
  ...
  local function reload(module_name, env, on_values, on_error)
    local _683_0, _684_0 = pcall(specials["load-code"]("return require(...)", env), module_name)
    if ((_683_0 == true) and (nil ~= _684_0)) then
      ...
      local new = nil
      do
        local _685_0, _686_0 = pcall(require, module_name)
        if ((_685_0 == true) and (nil ~= _686_0)) then
          local new0 = _686_0
          new = new0
        elseif (true and (nil ~= _686_0)) then
          local _0 = _685_0
          local msg = _686_0
          on_error("Repl", msg)
          new = old
      ...
      return on_values({"ok"})
    elseif ((_683_0 == false) and (nil ~= _684_0)) then
      local msg = _684_0
      ...
      elseif specials["macro-loaded"][module_name] then
        ...
        local function _691_()
          local _690_0 = msg:gsub("\n.*", "")
          return _690_0
        end
        return on_error("Runtime", _691_())
      end
    end
  end
  local function run_command(read, on_error, f)
    local _694_0, _695_0, _696_0 = pcall(read)
    if ((_694_0 == true) and (_695_0 == true) and (nil ~= _696_0)) then
      local val = _696_0
      local _697_0, _698_0 = pcall(f, val)
      if ((_697_0 == false) and (nil ~= _698_0)) then
        local msg = _698_0
        return on_error("Runtime", msg)
      end
    elseif (_694_0 == false) then
  ...
  commands.complete = function(env, read, on_values, on_error, scope, chars)
    ...
    return run_command(read, on_error, _702_)
  end
  ...
  local function apropos_2a(pattern, tbl, prefix, seen, names)
    for name, subtbl in pairs(tbl) do
      if (("string" == type(name)) and (package ~= subtbl)) then
        local _703_0 = type(subtbl)
        if (_703_0 == "function") then
          if ((prefix .. name)):match(pattern) then
            table.insert(names, (prefix .. name))
          end
        elseif (_703_0 == "table") then
          if not seen[subtbl] then
            ...
            apropos_2a(pattern, subtbl, (prefix .. name:gsub("%.", "/") .. "."), _705_, names)
          end
        end
      end
    end
    ...
    for _, path in ipairs(apropos(".*")) do
      ...
      do
        ...
        if ("function" == type(tgt)) then
          local _714_0 = (compiler.metadata):get(tgt, "fnl/docstring")
          if (nil ~= _714_0) then
            local docstr = _714_0
  ...
  local function resolve(identifier, _721_0, scope)
    local _722_ = _721_0
    local env = _722_
    local ___replLocals___ = _722_["___replLocals___"]
    local e = nil
    local function _723_(_241, _242)
      return (___replLocals___[scope.unmanglings[_242]] or env[_242])
    end
    e = setmetatable({}, {__index = _723_})
    local function _724_(...)
      ...
      if ((_725_0 == true) and (nil ~= _726_0)) then
        ...
        return _727_(pcall(specials["load-code"](code, e)))
      else
        local _ = _725_0
        return nil
      end
    end
    return _724_(pcall(compiler["compile-string"], tostring(identifier), {scope = scope}))
  end
  commands.find = function(env, read, on_values, on_error, scope)
    local function _732_(_241)
      local _733_0 = nil
      do
        local _734_0 = utils["sym?"](_241)
        if (nil ~= _734_0) then
          local _735_0 = resolve(_734_0, env, scope)
          if (nil ~= _735_0) then
            _733_0 = debug.getinfo(_735_0)
          else
            _733_0 = _735_0
          end
        else
      ...
      if ((_G.type(_733_0) == "table") and (nil ~= _733_0.linedefined) and (nil ~= _733_0.short_src) and (nil ~= _733_0.source) and (_733_0.what == "Lua")) then
        local line = _733_0.linedefined
        local src = _733_0.short_src
        local source = _733_0.source
        local fnlsrc = nil
        do
          local _738_0 = compiler.sourcemap
          if (nil ~= _738_0) then
            _738_0 = _738_0[source]
          end
          if (nil ~= _738_0) then
            _738_0 = _738_0[line]
          end
    ...
    return run_command(read, on_error, _732_)
  end
  ...
  commands.compile = function(_, read, on_values, on_error, _0, _1, opts)
    local function _746_(_241)
      local _747_0, _748_0 = pcall(compiler.compile, _241, opts)
      if ((_747_0 == true) and (nil ~= _748_0)) then
        local result = _748_0
        return on_values({result})
      elseif (true and (nil ~= _748_0)) then
        local _2 = _747_0
        local msg = _748_0
        return on_error("Repl", ("Error compiling expression: " .. msg))
      end
    end
    return run_command(read, on_error, _746_)
  end
  ...
  local function load_plugin_commands(plugins)
    for i = #(plugins or {}), 1, -1 do
      for name, f in pairs(plugins[i]) do
        local _750_0 = name:match("^repl%-command%-(.*)")
        if (nil ~= _750_0) then
          local cmd_name = _750_0
          commands[cmd_name] = f
        end
      end
    end
  ...
  local function run_command_loop(input, read, loop, env, on_values, on_error, scope, chars, opts)
    ...
    do
      local _752_0 = commands[command_name]
      if (nil ~= _752_0) then
        local command = _752_0
  ...
  local function repl(_3foptions)
    ...
    local _761_ = utils.copy(_3foptions)
    local opts = _761_
    local _3ffennelrc = _761_["fennelrc"]
    local _ = nil
    opts.fennelrc = nil
    _ = nil
    ...
    byte_stream, clear_stream = parser.granulate(_763_)
    local chars = {}
    local read, reset = nil, nil
    local function _764_(parser_state)
    ...
    read, reset = parser.parser(_764_)
    depth = (depth + 1)
    ...
    if opts.registerCompleter then
      local function _770_()
        local _769_0 = opts.scope
        local function _771_(...)
          return completer(env, _769_0, ...)
        end
        return _771_
      end
      opts.registerCompleter(_770_())
    end
      ...
      elseif command_3f(src_string) then
        ...
        if not_eof_3f then
          local function _775_(...)
            local _776_0, _777_0 = ...
            if ((_776_0 == true) and (nil ~= _777_0)) then
              local src = _777_0
              local function _778_(...)
                local _779_0, _780_0 = ...
                if ((_779_0 == true) and (nil ~= _780_0)) then
                  local chunk = _780_0
                  ...
                  return xpcall(_781_, _782_)
                elseif ((_779_0 == false) and (nil ~= _780_0)) then
                  local msg = _780_0
                  clear_stream()
              ...
              return _778_(_785_(...))
            elseif ((_776_0 == false) and (nil ~= _777_0)) then
              local msg = _777_0
              clear_stream()
              return callbacks.onError("Compile", msg)
            end
          ...
          _775_(pcall(compiler.compile, form, _787_()))
  ...
  local function _793_(overrides, _3fopts)
    return repl(utils.copy(_3fopts, utils.copy(overrides)))
  end
  return setmetatable({}, {__call = _793_, __index = {repl = repl}})
end
package.preload["fennel.specials"] = package.preload["fennel.specials"] or function(...)
  ...
  local function wrap_env(env)
    ...
    local function _440_(_, key, value)
      if utils["string?"](key) then
    ...
    local function _442_()
      ...
      do
        ...
        for k, v in utils.stablepairs(env) do
          ...
          if utils["string?"](k) then
            _444_ = compiler["global-unmangling"](k)
          else
            _444_ = k
          end
          k_15_, v_16_ = _444_, v
      ...
      return next, _443_, nil
    end
    return setmetatable({}, {__index = _438_, __newindex = _440_, __pairs = _442_})
  end
  ...
  local function current_global_names(_3fenv)
    local mt = nil
    do
      local _447_0 = getmetatable(_3fenv)
      if ((_G.type(_447_0) == "table") and (nil ~= _447_0.__pairs)) then
        local mtpairs = _447_0.__pairs
        local tbl_14_ = {}
  ...
  local function load_code(code, _3fenv, _3ffilename)
    ...
    local _452_0, _453_0 = rawget(_G, "setfenv"), rawget(_G, "loadstring")
    if ((nil ~= _452_0) and (nil ~= _453_0)) then
      local setfenv = _452_0
      local loadstring = _453_0
  ...
  local function doc_2a(tgt, name)
    if not tgt then
      ...
      if ((type(tgt) == "function") or ((type(mt) == "table") and (type(mt.__call) == "function"))) then
        local elts = nil
        do
          local _455_0 = ((compiler.metadata):get(tgt, "fnl/arglist") or {"#<unknown-arguments>"})
          table.insert(_455_0, 1, name)
          elts = _455_0
        end
  ...
  local function compile_value(v)
    ...
    local chunk = {}
    local _464_ = compiler.compile1(v, scope, chunk, opts)
    local _465_ = _464_[1]
    local v0 = _465_[1]
    return v0
  end
  ...
  local function get_fn_name(ast, scope, f_scope, fn_name, multi, _470_0)
    local _471_ = _470_0
    local nval = _471_["nval"]
    local tail = _471_["tail"]
    if (fn_name and (fn_name[1] ~= "nil")) then
      local _472_
      if not multi then
        local _473_
        if ((nval == 0) or tail) then
          _473_ = scope
        else
          _473_ = f_scope
        end
        _472_ = compiler["declare-local"](fn_name, _473_, ast)
      else
        _472_ = compiler["symbol-to-expression"](fn_name, scope)[1]
      end
      return _472_, not multi, 3
    else
      return nil, true, 2
    end
  end
  local function compile_named_fn(ast, f_scope, f_chunk, parent, index, fn_name, local_3f, arg_name_list, f_metadata)
    ...
    local _477_
    if local_3f then
      _477_ = "local function %s(%s)"
    else
      _477_ = "%s = function(%s)"
    end
    compiler.emit(parent, string.format(_477_, fn_name, table.concat(arg_name_list, ", ")), ast)
  ...
  local function get_function_metadata(ast, arg_list, index)
    ...
    local function _482_(_241, _242)
      _241["fnl/docstring"] = _242
      return _241
    end
    return maybe_metadata(ast, utils["kv-table?"], _480_, maybe_metadata(ast, utils["string?"], _482_, {["fnl/arglist"] = arg_list}, index))
  end
  SPECIALS.fn = function(ast, scope, parent, opts)
    local f_scope = nil
    do
      local _483_0 = compiler["make-scope"](scope)
      _483_0["vararg"] = false
      f_scope = _483_0
    end
    local f_chunk = {}
    ...
    local fn_name, local_3f, index = get_fn_name(ast, scope, f_scope, fn_sym, multi, opts)
  ...
  SPECIALS.lua = function(ast, _, parent)
    ...
    local _489_
    do
      local _488_0 = utils["sym?"](ast[2])
      if (nil ~= _488_0) then
        _489_ = tostring(_488_0)
      else
        _489_ = _488_0
      end
    end
    ...
    local _493_
    do
      local _492_0 = utils["sym?"](ast[3])
      if (nil ~= _492_0) then
        _493_ = tostring(_492_0)
      else
        _493_ = _492_0
      end
    end
  ...
  local function dot(ast, scope, parent)
    ...
    local _496_ = compiler.compile1(lhs_node, scope, parent, {nval = 1})
    local lhs = _496_[1]
    if (len == 2) then
      return tostring(lhs)
    else
      ...
      for i = 3, len do
        ...
        if (utils["string?"](index) and utils["valid-lua-identifier?"](index)) then
          ...
          local _497_ = compiler.compile1(index, scope, parent, {nval = 1})
          local index0 = _497_[1]
  ...
  SPECIALS.let = function(_504_0, scope, parent, opts)
    local _505_ = _504_0
    local _ = _505_[1]
    local bindings = _505_[2]
    local ast = _505_
  ...
  local function if_2a(ast, scope, parent, opts)
    ...
    if (#ast == 2) then
      ...
      for i = 2, (#ast - 1), 2 do
        local condchunk = {}
        local _514_ = compiler.compile1(ast[i], do_scope, condchunk, {nval = 1})
        local cond = _514_[1]
  ...
  local function remove_until_condition(bindings, ast)
    ...
    for i = (#bindings - 1), 3, -1 do
      local _520_0 = clause_3f(bindings[i])
      if ((_520_0 == false) or (_520_0 == nil)) then
      elseif (nil ~= _520_0) then
        local clause = _520_0
  ...
  local function compile_until(_3fcondition, scope, chunk)
    if _3fcondition then
      local _522_ = compiler.compile1(_3fcondition, scope, chunk, {nval = 1})
      local condition_lua = _522_[1]
  ...
  local function method_call(ast, scope, parent)
    ...
    local _532_ = compiler.compile1(ast[2], scope, parent, {nval = 1})
    local target = _532_[1]
    local args = {}
    for i = 4, #ast do
      local subexprs = nil
      local _533_
      ...
      subexprs = compiler.compile1(ast[i], scope, parent, {nval = _533_})
      local tbl_17_ = args
      local i_18_ = #tbl_17_
  ...
  SPECIALS.hashfn = function(ast, scope, parent)
    ...
    local f_scope = nil
    do
      local _542_0 = compiler["make-scope"](scope)
      _542_0["vararg"] = false
      _542_0["hashfn"] = true
      f_scope = _542_0
    end
  ...
  local function short_circuit_safe_3f(x, scope)
    ...
    elseif utils["list?"](x) then
      if utils["sym?"](x[1]) then
        local _549_0 = str1(x)
        if ((_549_0 == "fn") or (_549_0 == "hashfn") or (_549_0 == "let") or (_549_0 == "local") or (_549_0 == "var") or (_549_0 == "set") or (_549_0 == "tset") or (_549_0 == "if") or (_549_0 == "each") or (_549_0 == "for") or (_549_0 == "while") or (_549_0 == "do") or (_549_0 == "lua") or (_549_0 == "global")) then
          return false
        elseif (((_549_0 == "<") or (_549_0 == ">") or (_549_0 == "<=") or (_549_0 == ">=") or (_549_0 == "=") or (_549_0 == "not=") or (_549_0 == "~=")) and (comparator_special_type(x) == "binding")) then
          return false
        else
  ...
  local function emit_short_circuit_if(ast, scope, parent, name, subast, accumulator, expr_string, setter)
    ...
    compiler.emit(parent, ("if %s then"):format(_559_()), subast)
    do
      local chunk = {}
    ...
    for subast in iter_args(ast) do
      if ((nil ~= next(operands)) and ((name == "or") or (name == "and")) and not short_circuit_safe_3f(subast, scope)) then
        ...
        if not accumulator then
          accumulator = tostring(compiler.gensym(scope, name))
        end
  ...
  local function define_arithmetic_special(name, zero_arity, unary_prefix, _3flua_name)
    local _564_
    do
      local _563_0 = (_3flua_name or name)
      local function _565_(...)
        return operator_special(_563_0, zero_arity, unary_prefix, ...)
      end
      _564_ = _565_
    end
    SPECIALS[name] = _564_
  ...
  local function bitop_special(native_name, lib_name, zero_arity, unary_prefix, ast, scope, parent)
    if (#ast == 1) then
      ...
      for i = 2, len do
        ...
        subexprs = compiler.compile1(ast[i], scope, parent, {nval = _566_})
  ...
  SPECIALS.bnot = function(ast, scope, parent)
    compiler.assert((#ast == 2), "expected one argument", ast)
    local _574_ = compiler.compile1(ast[2], scope, parent, {nval = 1})
    local value = _574_[1]
    if utils.root.options.useBitLib then
  ...
  local function native_comparator(op, _576_0, scope, parent)
    local _577_ = _576_0
    local _ = _577_[1]
    local lhs_ast = _577_[2]
    local rhs_ast = _577_[3]
    local _578_ = compiler.compile1(lhs_ast, scope, parent, {nval = 1})
    local lhs = _578_[1]
    local _579_ = compiler.compile1(rhs_ast, scope, parent, {nval = 1})
    local rhs = _579_[1]
  ...
  local function binding_comparator(op, chain_op, ast, scope, parent)
    ...
    for i = 2, #ast do
      ...
      if (utils["idempotent-expr?"](ast[i]) or (i == 2) or (i == #ast)) then
        ...
        local my_sym = tostring(compiler.gensym(scope))
    ...
    return ("(" .. table.concat(_583_, chain) .. ")")
  end
  local function define_comparator_special(name, _3flua_op, _3fchain_op)
    do
      ...
      local function opfn(ast, scope, parent)
        ...
        local _585_0 = comparator_special_type(ast)
        if (_585_0 == "native") then
          return native_comparator(op, ast, scope, parent)
        elseif (_585_0 == "idempotent") then
          return idempotent_comparator(op, _3fchain_op, ast, scope, parent)
        elseif (_585_0 == "binding") then
  ...
  local function make_compiler_env(ast, scope, parent, _3fopts)
    local provided = nil
    do
      local _593_0 = (_3fopts or utils.root.options)
      if ((_G.type(_593_0) == "table") and (_593_0["compiler-env"] == "strict")) then
        provided = safe_compiler_env()
      elseif ((_G.type(_593_0) == "table") and (nil ~= _593_0.compilerEnv)) then
        local compilerEnv = _593_0.compilerEnv
        provided = compilerEnv
      elseif ((_G.type(_593_0) == "table") and (nil ~= _593_0["compiler-env"])) then
        local compiler_env = _593_0["compiler-env"]
    ...
    local function _596_(symbol)
      compiler.assert(compiler.scopes.macro, "must call from macro", ast)
      return compiler.scopes.macro.manglings[tostring(symbol)]
    end
    local function _597_(base)
      return utils.sym(compiler.gensym((compiler.scopes.macro or scope), base))
    end
    local function _598_(form)
      compiler.assert(compiler.scopes.macro, "must call from macro", ast)
      return compiler.macroexpand(form, compiler.scopes.macro)
    end
    env = {["assert-compile"] = compiler.assert, ["ast-source"] = utils["ast-source"], ["comment?"] = utils["comment?"], ["fennel-module-name"] = fennel_module_name, ["get-scope"] = _595_, ["in-scope?"] = _596_, ["list?"] = utils["list?"], ["macro-loaded"] = macro_loaded, ["multi-sym?"] = utils["multi-sym?"], ["sequence?"] = utils["sequence?"], ["sym?"] = utils["sym?"], ["table?"] = utils["table?"], ["varg?"] = utils["varg?"], _AST = ast, _CHUNK = parent, _IS_COMPILER = true, _SCOPE = scope, _SPECIALS = compiler.scopes.global.specials, _VARARG = utils.varg(), comment = utils.comment, gensym = _597_, list = utils.list, macroexpand = _598_, sequence = utils.sequence, sym = utils.sym, unpack = unpack, version = utils.version, view = view}
    env._G = env
  ...
  local _601_ = _599_(...)
  local dirsep = _601_[1]
  local pathsep = _601_[2]
  local pathmark = _601_[3]
  ...
  local function search_module(modulename, _3fpathstring)
    ...
    local function try_path(path)
      ...
      local _602_0 = (io.open(filename) or io.open(filename2))
      if (nil ~= _602_0) then
        local file = _602_0
        file:close()
        return filename
    ...
    local function find_in_path(start, _3ftried_paths)
      local _604_0 = fullpath:match(pattern, start)
      if (nil ~= _604_0) then
        local path = _604_0
        local _605_0, _606_0 = try_path(path)
        if (nil ~= _605_0) then
          local filename = _605_0
          return filename
        elseif ((_605_0 == nil) and (nil ~= _606_0)) then
          local error = _606_0
          local function _608_()
            local _607_0 = (_3ftried_paths or {})
            table.insert(_607_0, error)
            return _607_0
          end
          return find_in_path((start + #path + 1), _608_())
        end
      else
        local _ = _604_0
  ...
  local function make_searcher(_3foptions)
    local function _613_(module_name)
      local opts = utils.copy(utils.root.options)
      for k, v in pairs((_3foptions or {})) do
        opts[k] = v
      end
      opts["module-name"] = module_name
      local _614_0, _615_0 = search_module(module_name)
      if (nil ~= _614_0) then
        local filename = _614_0
        local function _616_(...)
          return utils["fennel-module"].dofile(filename, opts, ...)
        end
        return _616_, filename
      elseif ((_614_0 == nil) and (nil ~= _615_0)) then
        local error = _615_0
        return error
      end
    end
  ...
  local function fennel_macro_searcher(module_name)
    local opts = nil
    do
      local _618_0 = utils.copy(utils.root.options)
      _618_0["module-name"] = module_name
      _618_0["env"] = "_COMPILER"
      _618_0["requireAsInclude"] = false
      _618_0["allowedGlobals"] = nil
      opts = _618_0
    end
    local _619_0 = search_module(module_name, utils["fennel-module"]["macro-path"])
    if (nil ~= _619_0) then
      ...
      return _620_, filename
    end
  end
  local function lua_macro_searcher(module_name)
    local _625_0 = search_module(module_name, package.path)
    if (nil ~= _625_0) then
      local filename = _625_0
      local code = nil
      do
        ...
        code = close_handlers_10_(_G.xpcall(_627_, (package.loaded.fennel or debug).traceback))
      end
  ...
  local function search_macro_module(modname, n)
    local _629_0 = macro_searchers[n]
    if (nil ~= _629_0) then
      local f = _629_0
      local _630_0, _631_0 = f(modname)
      if ((nil ~= _630_0) and true) then
        local loader = _630_0
        local _3ffilename = _631_0
  ...
  local function sandbox_fennel_module(modname)
    if ((modname == "fennel.macros") or (package and package.loaded and ("table" == type(package.loaded[modname])) and (package.loaded[modname].metadata == compiler.metadata))) then
      local function _634_(_, ...)
        return (compiler.metadata):setall(...)
      end
      return {metadata = {setall = _634_}, view = view}
    end
  end
  local function _636_(modname)
    ...
    return (macro_loaded[modname] or sandbox_fennel_module(modname) or _637_())
  end
  safe_require = _636_
  ...
  local function resolve_module_name(_638_0, _scope, _parent, opts)
    local _639_ = _638_0
    local second = _639_[2]
    local filename = _639_["filename"]
  ...
  local function include_path(ast, opts, path, mod, fennel_3f)
    ...
    do
      ...
      src = close_handlers_10_(_G.xpcall(_645_, (package.loaded.fennel or debug).traceback))
    end
  ...
  SPECIALS.include = function(ast, scope, parent, opts)
    ...
    local modexpr = nil
    do
      local _648_0, _649_0 = pcall(resolve_module_name, ast, scope, parent, opts)
      if ((_648_0 == true) and (nil ~= _649_0)) then
        local modname = _649_0
    ...
    if ((modexpr.type ~= "literal") or ((modexpr[1]):byte() ~= 34)) then
      ...
      local function _653_()
        local _652_0 = search_module(mod)
        if (nil ~= _652_0) then
          local fennel_path = _652_0
      ...
      res = ((utils["member?"](mod, (utils.root.options.skipInclude or {})) and opts.fallback(modexpr, true)) or include_circular_fallback(mod, modexpr, opts.fallback, ast) or utils.root.scope.includes[mod] or _653_())
...
package.preload["fennel.compiler"] = package.preload["fennel.compiler"] or function(...)
  ...
  local function autogensym(base, scope)
    local _283_0 = utils["multi-sym?"](base)
    if (nil ~= _283_0) then
      local parts = _283_0
      ...
      return (scope.autogensyms[base] or _284_())
    end
  end
  ...
  local function declare_local(symbol, scope, ast, _3fvar_3f, _3fdeferred_scope_changes)
    ...
    mangling = string.gsub(string.gsub(raw, "-", "_"), "[^%w_]", _289_)
  ...
  local function make_metadata()
    local function _312_(self, tgt, _3fkey)
      if self[tgt] then
        if (nil ~= _3fkey) then
    ...
    local function _315_(self, tgt, key, value)
      self[tgt] = (self[tgt] or {})
      self[tgt][key] = value
      return tgt
    end
    local function _316_(self, tgt, ...)
      local kv_len = select("#", ...)
      local kvs = {...}
      if ((kv_len % 2) ~= 0) then
    ...
    return setmetatable({}, {__index = {get = _312_, set = _315_, setall = _316_}, __mode = "k"})
  end
  ...
  local function handle_compile_opts(exprs, parent, opts, ast)
    ...
    if opts.target then
      ...
      emit(parent, string.format("%s = %s", opts.target, _326_()), ast)
    end
  ...
  local function find_macro(ast, scope)
    local macro_2a = nil
    do
      local _329_0 = utils["sym?"](ast[1])
      if (_329_0 ~= nil) then
        local _330_0 = tostring(_329_0)
        if (_330_0 ~= nil) then
          macro_2a = scope.macros[_330_0]
        else
          macro_2a = _330_0
        end
      else
  ...
  local function propagate_trace_info(_334_0, _index, node)
    local _335_ = _334_0
    local byteend = _335_["byteend"]
    local bytestart = _335_["bytestart"]
    local filename = _335_["filename"]
    local line = _335_["line"]
    do
  ...
  local function macroexpand_2a(ast, scope, _3fonce)
    ...
    if utils["list?"](ast) then
      _341_0 = find_macro(ast, scope)
    else
    _341_0 = nil
    end
    if (_341_0 == false) then
      return ast
    elseif (nil ~= _341_0) then
      local macro_2a = _341_0
      ...
      ok, transformed = xpcall(_343_, _344_())
      local function _345_(...)
        return propagate_trace_info(ast, ...)
      end
      utils["walk-tree"](transformed, comp(_345_, quote_literal_nils))
  ...
  local function callable_3f(_351_0, ctype, callee)
    local _352_ = _351_0
    local call_ast = _352_[1]
  ...
  local function compile_function_call(ast, scope, parent, opts, compile1, len)
    local _354_ = compile1(ast[1], scope, parent, {nval = 1})[1]
    local callee = _354_[1]
    local ctype = _354_["type"]
    local fargs = {}
    ...
    for i = 2, len do
      ...
      subexprs = compile1(ast[i], scope, parent, {nval = _355_})
  ...
  local function compile_varg(ast, scope, parent, opts)
    ...
    if scope.hashfn then
      ...
      _360_ = "unexpected vararg"
    end
    assert_compile(scope.vararg, _360_, ast)
  ...
  local function serialize_number(n)
    local _363_0 = string.gsub(tostring(n), ",", ".")
    return _363_0
  end
  local function compile_scalar(ast, _scope, parent, opts)
    local serialize = nil
    do
      local _364_0 = type(ast)
      if (_364_0 == "nil") then
        serialize = tostring
      elseif (_364_0 == "boolean") then
        serialize = tostring
      elseif (_364_0 == "string") then
        serialize = serialize_string
      elseif (_364_0 == "number") then
  ...
  local function compile_table(ast, scope, parent, opts, compile1)
    local function escape_key(k)
      if ((type(k) == "string") and utils["valid-lua-identifier?"](k)) then
        ...
        local _366_ = compile1(k, scope, parent, {nval = 1})
        local compiled = _366_[1]
    ...
    do
      ...
      for k in utils.stablepairs(ast) do
        local val_19_ = nil
        if not keys[k] then
          local _369_ = compile1(ast[k], scope, parent, {nval = 1})
          local v = _369_[1]
  ...
  local function destructure(to, from, ast, scope, parent, opts)
    local opts0 = (opts or {})
    local _373_ = opts0
    local declaration = _373_["declaration"]
    local forceglobal = _373_["forceglobal"]
    local forceset = _373_["forceset"]
    local isvar = _373_["isvar"]
    local symtype = _373_["symtype"]
    ...
    local function dynamic_set_target(_386_0)
      local _387_ = _386_0
      local _ = _387_[1]
      local target = _387_[2]
      local keys = {(table.unpack or unpack)(_387_, 3)}
    ...
    local function destructure_kv_rest(s, v, left, excluded_keys, destructure1)
      ...
      exclude_str = table.concat(_392_, ", ")
    ...
    local function optimize_table_destructure_3f(left, right)
      local function _394_()
        ...
        for _, d in ipairs(left) do
          ...
          all = (utils["sym?"](d) and not tostring(d):find("^&"))
        end
        return all
      end
      return (utils["sequence?"](left) and utils["sequence?"](right) and _394_())
    end
    local function destructure_table(left, rightexprs, top_3f, destructure1, up1)
      if optimize_table_destructure_3f(left, rightexprs) then
        ...
        do
          local _395_0 = nil
          if top_3f then
            _395_0 = exprs1(compile1(from, scope, parent))
          else
            _395_0 = exprs1(rightexprs)
          end
          if (_395_0 == "") then
            right = "nil"
  ...
  local function compile_asts(asts, options)
    ...
    local _409_ = utils.root
    _409_["set-reset"](_409_)
  ...
  local function compile(from, _3fopts)
    local _412_0 = type(from)
    if (_412_0 == "userdata") then
      local function _413_()
        local _414_0 = from:read(1)
        if (nil ~= _414_0) then
          return _414_0:byte()
        else
          return _414_0
      ...
      return compile_stream(_413_, _3fopts)
    elseif (_412_0 == "function") then
  ...
  local function traceback_frame(info)
    ...
    elseif (info.what == "C") then
      ...
      if (info.what == "Lua") then
        ...
        return string.format("\9%s:%d: in function %s", info.short_src, info.currentline, _419_())
  ...
  local function traceback(_3fmsg, _3fstart)
    ...
    if ((msg:find("^%g+:%d+:%d+ Compile error:.*") or msg:find("^%g+:%d+:%d+ Parse error:.*")) and not utils["debug-on?"]("trace")) then
      ...
      while not done_3f do
        do
          local _423_0 = debug.getinfo(level, "Sln")
          if (_423_0 == nil) then
            done_3f = true
          elseif (nil ~= _423_0) then
            local info = _423_0
  ...
  local function do_quote(form, scope, parent, runtime_3f)
    ...
    elseif utils["sequence?"](form) then
      ...
      return string.format("setmetatable({%s}, {filename=%s, line=%s, sequence=%s})", mixed_concat(mapped, ", "), filename, _433_, "(getmetatable(sequence()))['sequence']")
    elseif (type(form) == "table") then
      ...
      return string.format("setmetatable({%s}, {filename=%s, line=%s})", mixed_concat(mapped, ", "), filename, _436_())
...
package.preload["fennel.friend"] = package.preload["fennel.friend"] or function(...)
  ...
  local function read_line(filename, line, _3fsource)
    if _3fsource then
      ...
      return close_handlers_10_(_G.xpcall(_180_, (package.loaded.fennel or debug).traceback))
    end
  end
  ...
  local function highlight_line(codeline, col, _3fendcol, opts)
    if ((opts and (false == opts["error-pinpoint"])) or (os and os.getenv and os.getenv("NO_COLOR"))) then
      ...
      local _183_ = (opts or {})
      local error_pinpoint = _183_["error-pinpoint"]
      ...
      local _185_ = (error_pinpoint or {"\27[7m", "\27[0m"})
      local open = _185_[1]
      local close = _185_[2]
      return (sub(codeline, 1, col) .. open .. sub(codeline, (col + 1), (endcol + 1)) .. close .. sub(codeline, (endcol + 2), eol))
    end
  end
  local function friendly_msg(msg, _187_0, source, opts)
    local _188_ = _187_0
    local col = _188_["col"]
    local endcol = _188_["endcol"]
    local endline = _188_["endline"]
    local filename = _188_["filename"]
    local line = _188_["line"]
  ...
  local function assert_compile(condition, msg, ast, source, opts)
    if not condition then
      local _192_ = utils["ast-source"](ast)
      local col = _192_["col"]
...
package.preload["fennel.parser"] = package.preload["fennel.parser"] or function(...)
  ...
  local function granulate(getchunk)
    ...
    local function _194_(parser_state)
      if not done_3f then
        if (index <= #c) then
          ...
          local _195_0 = getchunk(parser_state)
          local function _196_()
            local char = _195_0
            return (char ~= "")
          end
          if ((nil ~= _195_0) and _196_()) then
            local char = _195_0
            c = char
            index = 2
            return c:byte()
  ...
  local function parser_fn(getbyte, filename, _204_0)
    local _205_ = _204_0
    local options = _205_
    local comments = _205_["comments"]
    local source = _205_["source"]
    local unfriendly = _205_["unfriendly"]
    local stack = {}
    ...
    local function whitespace_3f(b)
      local function _213_()
        local _212_0 = options.whitespace
        if (nil ~= _212_0) then
          _212_0 = _212_0[b]
        end
        return _212_0
      end
      return ((b == 32) or ((9 <= b) and (b <= 13)) or _213_())
    end
    ...
    local function parse_stream()
      ...
      local function dispatch(v, _3fsource, _3fraw)
        ...
        local v0 = nil
        do
          local _217_0 = (_3fsource and ("table" ~= type(v)) and utils["hook-opts"]("parse-literal", options, v, _3fsource, _3fraw, stack))
          if (nil ~= _217_0) then
            local hookv = _217_0
            v0 = hookv
          else
        ...
        local _219_0 = stack[#stack]
        if (_219_0 == nil) then
          retval, done_3f = v0, true
          return nil
        elseif ((_G.type(_219_0) == "table") and (nil ~= _219_0.prefix)) then
          local prefix = _219_0.prefix
          local source0 = nil
          do
            local _220_0 = table.remove(stack)
            set_source_fields(_220_0)
            source0 = _220_0
          end
          local list = utils.list(utils.sym(prefix, source0), v0)
          return dispatch(utils.copy(source0, list))
        elseif (nil ~= _219_0) then
          local top = _219_0
      ...
      local function badend()
        ...
        do
          local tbl_17_ = {}
          local i_18_ = #tbl_17_
          for _, _222_0 in ipairs(stack) do
            local _223_ = _222_0
            local closer = _223_["closer"]
        ...
        return parse_error(string.format("expected closing delimiter%s %s", _225_, string.char(unpack(closers))))
      end
      ...
      local function parse_comment(b, contents)
        if (b and (10 ~= b)) then
          ...
          return parse_comment(getb(), _228_())
      ...
      local function add_comment_at(comments0, index, node)
        local _232_0 = comments0[index]
        if (nil ~= _232_0) then
          local existing = _232_0
      ...
      local function parse_string_loop(chars, b, state)
        ...
        local state0 = nil
        do
          local _243_0 = {state, b}
          if ((_G.type(_243_0) == "table") and (_243_0[1] == "base") and (_243_0[2] == 92)) then
            state0 = "backslash"
          elseif ((_G.type(_243_0) == "table") and (_243_0[1] == "base") and (_243_0[2] == 34)) then
            state0 = "done"
          elseif ((_G.type(_243_0) == "table") and (_243_0[1] == "backslash") and (_243_0[2] == 10)) then
      ...
      local function parse_string(source0)
        if not whitespace_since_dispatch then
          parse_error("expected whitespace before string")
        end
        ...
        local _248_0 = (rawget(_G, "loadstring") or load)(("return " .. formatted))
        if (nil ~= _248_0) then
          local load_fn = _248_0
          return dispatch(load_fn(), source0, raw)
        elseif (_248_0 == nil) then
      ...
      local function parse_number(rawstr, source0)
        ...
        if rawstr:match("^%d") then
          ...
          local _254_0 = tonumber(number_with_stripped_underscores)
          if (nil ~= _254_0) then
            local x = _254_0
      ...
      local function parse_sym(b)
        if ((b == 58) and not whitespace_since_dispatch) then
          parse_error("expected whitespace before token")
        end
...
package.preload["fennel.utils"] = package.preload["fennel.utils"] or function(...)
  ...
  local function call_of_3f(ast, callee)
    return (list_3f(ast) and ast[1] and (callee == deref(ast[1])))
  end
  ...
  local warned = {}
  local function check_plugin_version(_165_0)
    local _166_ = _165_0
    local plugin = _166_
    local name = _166_["name"]
    local versions = _166_["versions"]
  ...
  local function hook_opts(event, _3foptions, ...)
    ...
    local function _169_(...)
      local _168_0 = _3foptions
      if (nil ~= _168_0) then
        _168_0 = _168_0.plugins
      end
      return _168_0
    end
    local function _172_(...)
      local _171_0 = root.options
      if (nil ~= _171_0) then
        _171_0 = _171_0.plugins
      end
      return _171_0
    end
    plugins = (_169_(...) or _172_(...))
    if plugins then
      local result = nil
      for _, plugin in ipairs(plugins) do
        if (nil ~= result) then break end
        check_plugin_version(plugin)
        local _174_0 = plugin[event]
        if (nil ~= _174_0) then
          local f = _174_0
          result = f(...)
        else
...
local function eval(str, _3foptions, ...)
  ...
  loader = specials["load-code"](lua_source, env, _799_(...))
  opts.filename = nil
  return loader(...)
end
...
local function syntax()
  ...
  for k, v in pairs(_G) do
    local _800_0 = type(v)
    if (_800_0 == "function") then
      out[k] = {["function?"] = true, ["global?"] = true}
    elseif (_800_0 == "table") then
...
do
  ...
  package.preload[module_name] = _804_
  _ = nil
  local env = nil
  do
    local _805_0 = specials["make-compiler-env"](nil, compiler.scopes.compiler, {})
    _805_0["utils"] = utils
    _805_0["fennel"] = mod
    _805_0["get-function-metadata"] = specials["get-function-metadata"]
    env = _805_0
  end
